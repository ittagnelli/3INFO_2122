...
int dispari[36] = {1, 0, 5, 7, 9, 13, 15, 19, 21, 1, 0, 5, 7, 9, 13, 15, 17, 19, 21, 2, 4, 18, 20, 11, 3, 6, 8, 12, 14, 16, 10, 22, 25, 24, 23};
...
void main(int argc, char *argv[])
{
    ...
    int tot_finale = somma_pari(vet_pari) + somma_dispari(vet_pari);
